...
# https://github.com/hysteria087/virt-api

# if you see the github repository, you may get all there
# vm-agent code, working as a linux service.
# Below, the code you see is not all libvirt_api.py code,
# the original one needs also another libraries.
